          ...
          <div className="absolute inset-0 flex items-center">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl">
                <div className="text-md font-cerebri font-normal uppercase tracking-wide text-gray-300 mb-4">
                  {article.category}
                </div>
                <h1 className="text-[clamp(2.5rem,5vw,4rem)] leading-none tracking-tight font-serif text-white mb-6">
                  {article.title}
                </h1>
                <div className="flex items-center gap-4 text-gray-300 font-cerebri">
          ...
          <div className="max-w-4xl mx-auto">
            <div 
              className="prose prose-invert max-w-none 
                ...
                prose-p:font-cerebri prose-p:font-light prose-p:text-lg prose-p:leading-relaxed
                prose-ul:font-cerebri prose-ul:font-light prose-ul:text-lg
                prose-li:my-2" 
