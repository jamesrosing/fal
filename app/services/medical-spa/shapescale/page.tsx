...
const services = [
  {
    ...
    image: mediaId("medical-spa/3d-body-scanning")
  },
  {
    ...
    image: mediaId("medical-spa/body-composition")
  },
  {
    ...
    image: mediaId("medical-spa/treatment-planning")
  }
]
    ...
    <main className="min-h-screen bg-black">
      ...
      <section className="relative h-[70vh]">
        <div className="absolute inset-0">
          <CldImage publicId="medical-spa/body-analysis-hero.jpg" alt="ShapeScale Body Analysis Services" priority fill / config={{
          cloud: {
            cloudName: 'dyrzyfg3w'
          }
        }}>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h2 className="mb-8 text-[clamp(2.5rem,5vw,4rem)] leading-none tracking-tight font-serif">
                Advanced 3D body composition analysis and tracking
              </h2>
              <div className="space-y-6 text-lg font-cerebri font-light">
                <p>
                  Our state-of-the-art ShapeScale body analysis services provide detailed insights into your body composition, helping us create personalized treatment plans for optimal results.
                </p>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="w-full lg:w-1/2 text-white">
                  ...
                  <div className="mt-8">
                    <LearnMoreButton href="/appointment">Schedule a ShapeScale Analysis</LearnMoreButton>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="relative py-24 bg-[#f5f5f5] dark:bg-black">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="space-y-6 text-lg font-cerebri font-light">
              <p>
                Begin your transformation journey with a comprehensive ShapeScale analysis that will guide your personalized treatment plan.
              </p>
              <div className="space-y-4">
                <LearnMoreButton href="/appointment">Schedule Your ShapeScale Analysis</LearnMoreButton>
              </div>
            </div>
          </motion.div>
        </div>
