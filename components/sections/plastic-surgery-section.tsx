...
export function PlasticSurgerySection() {
  ...
  const imageUrl = "https://res.cloudinary.com/dyrzyfg3w/image/upload/v1740641293/plastic-surgery-section.jpg";
  
  // Use next/image directly for more reliability with the full URL
